...
public class ShapeFactory {
    ...
    /**
     * Конструктор класу ShapeFactory, в даному класі в нас йде створення фігури.
     *
     * @param shape_type Даний параметер відповідає за тип фігурки.
     * @throws Error Відповідна помилка виходить, якщо даний тип фігурки не підтримується.
     */
    ...
    /**
     * Даний метод створює фігуру, яка має вигляд зірки із вказаними параметрами.
     *
     * @param arms    Створюємо кількість віток зірки.
     * @param center  Ставимо центральну точку зірки.
     * @param rOuter  Зовнішній радіус зірки.
     * @param rInner  Внутрішній радіус зірки.
     * @return Повертає створену фігурку зірки.
     */
